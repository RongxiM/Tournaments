...
//find the max id
//add tje mew record with the new ID (max + 1)
//convertthe prizes to List<string>
...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class textConnectorProcessor
    {
        ...
        public static List<TeamModel> ConvertToTeamModels(this List<string> lines, string peopleFileName)
        {
            ...
            //3(id of the team), Tim's Team(name of the team), 1|3|5(each id of each person)
        ...
        {   //id = 0
            ...
            //Prizes = 4
            //Rounds = 5
            //id, TournamentName, EntryFee, (id|id|id - EnteredGame), (id|id|id - prizes), (Rounds - id^id^id|id^id^id|id^id^id)
            List<TournamentModel> output = new List<TournamentModel>();
            List<TeamModel> teams = teamFileName.FullFilePath().LoadFile().ConvertToTeamModels(GlobalConfig.PeopleFile);
        ...
        public static void SaveToTournamentFile(this List<TournamentModel> models, string fileName)
        {
            ...
            //EnteredTeams =3
            //Prizes = 4
            //Rounds = 5 (Rounds - id^id^id|id^id^id|id^id^id)
        ...
        private static List<MatchupEntryModel> ConvertStringToMatchupEntryModels(string input)
        {
            ...
            List<String> mathchingEntries = new List<string>();
            ...
            foreach (string id in ids)
            {
                foreach (string entry in entries)
                {
                    ...
                    if (cols[0] == id)
                    {
                        mathchingEntries.Add(entry);
                    }
                }
            }

            output = mathchingEntries.ConvertToMatchupEntryModels();
